...
def get_secure_logger(name: str) -> SecureLogger:
    ...
    NOT deprecated (2026-07 audit sweep): the once-planned migration to
    shared.unified_logging was evaluated and rejected — UnifiedLogger does
    not sanitize positional args the way SecureLogger does, so this remains
    the module logger for main/tools/middleware/bootstrap.
    """
