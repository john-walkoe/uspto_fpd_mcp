...
fetched on demand. Two are eager (`FPD_Search_petitions_minimal`,
`FPD_get_guidance`); the rest are deferred. That split is where this server's
context savings come from, and it is advertised in SERVER_INSTRUCTIONS.
