"""Docling-serve REST client for FPD PDF OCR extraction.
...
which is why DOCLING_MAX_PAGES defaults to 25 here (Lesson 19).
...
Env vars:
    ...
    DOCLING_MAX_PAGES   – Skip Docling for documents exceeding this page count
                          (default: 25). Prevents tool call timeouts on large
